...
namespace PlatonicSolids {
    Figure createTetrahedron(Color a) {
        ...
        return Figure({ p0, p1, p2, p3 }, { f0, f1, f2, f3 }, a);
    }
    ...
    Figure createCube(Color a) {
        ...
        return Figure({ p0, p1, p2, p3, p4, p5, p6, p7 }, { f0, f1, f2, f3, f4, f5 }, a);
    }
    ...
    Figure createOctahedron(Color a) {
        ...
        return Figure({ p0, p1, p2, p3, p4, p5 }, { f0, f1, f2, f3, f4, f5, f6, f7 }, a);
    }
    ...
    Figure createIcosahedron(Color a) {
        ...
        return Figure({ p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11 }, { f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, f18, f19}, a);
    }

    Figure createDodecahedron(Color a) {
        Figure ico = createIcosahedron(a);
        ...
        return Figure(p, { f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11 }, a);
    }
    ...
    Figure createTruncatedIcosahedron(Color ambient) {
        ...
        Figure figure = Figure(points, faces, ambient);
        return figure;
    }
    ...
    Figure createCone(Color a, const int n, const double h) {
        ...
        return Figure(points, faces, a);
    }


    Figure createSphere(Color a, const double radius, const int n) {
        Figure intermediate = createIcosahedron(a);
