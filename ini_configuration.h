...
namespace ini {
    ...
    /**
     * \brief The exception that is thrown when the parser encounters an unexpected
     * character.
     */
    ...
    public:
        ...
        /**
         * \brief Constructs a new UnexpectedCharacter instance by copying another
         * one.
         *
    ...
    /**
     * \brief The exception that is thrown by the parser when it encounters a
     * section that has the same name as a previously parsed section.
     */
    ...
    /**
     * \brief The exception that is thrown when the parser encounters an entry that
     * has the same key as a previously parsed key in the same section.
     */
    ...
    public:
         ...
         *
         * \param section_init The name of the section that contains the duplicate
         * entry. \param key_init     The name of the duplicate entry.
         */
    ...
    /**
     * \brief The execption that is thrown when the value of a nonexistent entry is
     * requested.
     *
     * Note that this exception is only thrown when the value of an Entry is
     * obtained; not when the entry is obtained from a Section.
     */
    class NonexistentEntry : public std::exception {
    private:
        /**
         * \brief The name of the section from which the nonexistent entry is
         * obtained.
         */
    ...
    public:
         ...
         *
         * \param section_name_init The name of the section from which the nonexistent
         * entry is obtained. \param entry_name_init   The name of the nonexistent
         * entry.
         */
    ...
    /**
     * \brief The execption that is thrown when the value of an entry in an
     * ini-configuration cannot be converted to the requested value.
     */
    ...
    public:
        ...
        /**
         * \brief Constructs a IncompatibleConversion exception by copying another
         * one.
         *
         * \param original The instance that is copied.
         */
         ...
         * \return A reference to this instance.
         */
        IncompatibleConversion& operator=(
            const IncompatibleConversion& original) throw();
    ...
    /**
     * \brief The class that represents an entry in the section of an INI
     * configuration.
     */
    class Entry {
    private:
    ...
    public:
        /**
         * \brief Constructs a new entry given the name of the section it belongs to
         * and its value.
         *
         * \param section_name_init The name of the section to which this entry
         * belongs. \param entry_name_init The name of this entry. \param
         * value_ptr_init A pointer to the value of this entry.
         */
        Entry(const std::string& section_name_init,
            const std::string& entry_name_init, const Value* const value_ptr_init);
         ...
         *
         * If the entry exists and can be represented as an int, the value is passed
         * to the caller through the parameter and \c true is returned.  If the entry
         * exists but is not representable as an int, an IncompatibleConversion
         * exception is thrown.  If the entry does not exist, \c false is returned and
         * the value of the parameter is not changed.
         *
         ...
         *
         * If the entry exists and can be represented as a double, the value is passed
         * to the caller through the parameter and \c true is returned.  If the entry
         * exists but is not representable as a double, an IncompatibleConversion
         * exception is thrown.  If the entry does not exist, \c false is returned and
         * the value of the parameter is not changed.
         *
         * \param ret_val The parameter through which the value is returned.
         ...
         *
         * If the entry exists and can be represented as a string, the value is passed
         * to the caller through the parameter and \c true is returned.  If the entry
         * exists but is not representable as a string, an IncompatibleConversion
         * exception is thrown.  If the entry does not exist, \c false is returned and
         * the value of the parameter is not changed.
         *
         * \param ret_val The parameter through which the value is returned.
         ...
         *
         * If the entry exists and can be represented as a bool, the value is passed
         * to the caller through the parameter and \c true is returned.  If the entry
         * exists but is not representable as a bool, an IncompatibleConversion
         * exception is thrown.  If the entry does not exist, \c false is returned and
         * the value of the parameter is not changed.
         *
         * \param ret_val The parameter through which the value is returned.
         ...
         * IncompatibleConversion exception is thrown.  If the entry does not exist,
         * \c false is returned and the value of the parameter is not changed.
         *
         * \param ret_val The parameter through which the value is returned.
         *
         * \return \c true if the value exists, \c false otherwise.
         ...
         * \brief Returns the value as an int.
         *
         * If the entry exists and can be represented as an int, it is returned.  If
         * the value is not representable as an int, an IncompatibleConversion
         ...
         * \brief Returns the value as a bool.
         *
         * If the entry exists and can be represented as a bool, it is returned.  If
         * the value is not representable as a bool, an IncompatibleConversion
         * exception is thrown.  If the entry does not exist, a NonexistentEntry
         * exception is thrown.
         *
         ...
         * If the value is not representable as an int tuple, an
         * IncompatibleConversion exception is thrown.  If the entry does not exist, a
         * NonexistentEntry exception is thrown.
         *
         ...
         * \brief Returns the value as a double tuple.
         *
         * If the entry exists and can be represented as a double tuple, it is
         * returned. If the value is not representable as a double tuple, an
         * IncompatibleConversion exception is thrown.  If the entry does not exist, a
         * NonexistentEntry exception is thrown.
         *
         ...
         * returned.
         *
         * \param def_val The default value that is returned if the value does not
         * exist.
         *
         * \return The value as an int or the default value if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The value as a double or the default value if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The value as a string or the default value if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The value as a bool or the default value if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The value as an int tuple or the default value if the value does
         * not exist.
         */
         ...
         * exist.
         *
         * \return The value as a double tuple or the default value if the value does
         * not exist.
         */
         ...
         *
         * This conversion operator allows a Value to be converted to an int when it
         ...
         *
         * This conversion operator allows a Value to be converted to a double when it
         * is assigned to a double variable.
         *
         ...
         *
         * This conversion operator allows a Value to be converted to a string when it
         ...
         *
         * This conversion operator allows a Value to be converted to a bool when it
         * is assigned to a bool variable.
         *
         ...
         *
         * This conversion operator allows a Value to be converted to an int tuple
         * when it is assigned to an int tuple variable.
         *
         ...
         * \brief An alias for as_int_or_die.
         *
         * This conversion operator allows a Value to be converted to a double tuple
         * when it is assigned to a double tuple variable.
         *
         ...
         *
         * \param def_val The value that is returned if the requested value does not
         * exist.
         *
         * \return The requested value as an int or def_val if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The requested value as a double or def_val if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The requested value as a string or def_val if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The requested value as a bool or def_val if the value does not
         * exist.
         */
         ...
         * exist.
         *
         * \return The requested value as an int tuple or def_val if the value does
         * not exist.
         */
         ...
         * exist.
         *
         * \return The requested value as a double tuple or def_val if the value does
         * not exist.
         */
    ...
    /**
     * \brief The type that is used to represent sections that are stored in the
     * configuration file.
     */
    class Section {
    private:
    ...
    public:
         ...
         * \param values_init An iterator to the map that stores the entries of the
         * section.
         */
         ...
         *
         * \return The entry corresponding to the key or an empty entry if the
    ...
    public:
        ...
        /**
         * \brief Formats the contents of the Configuration to text and prints it to
         * an output stream.
         *
     ...
     *
     * \param input_stream  The input stream from which the configuration is read.
     * \param configuration The Configuration object in which the parsed
